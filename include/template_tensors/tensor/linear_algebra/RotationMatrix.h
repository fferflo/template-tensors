...
template <typename TElementType, size_t TAxis1, size_t TAxis2, size_t TRowsCols>
...
public:
  ...
  __host__ __device__
  BasicRotationMatrix(TElementType angle, size_t rows_cols)
...
template <typename TElementType, size_t TAxis1, size_t TAxis2>
...
template <typename TElementType, size_t TAxis>
...
template <typename TElementType, size_t... TAxes>
...
template <typename TElementType, size_t TAxis, size_t TAxisNext, size_t... TAxes>
 ...
 */
template <typename TElementType, size_t... TAxes, typename... TArgs>
__host__ __device__
