...
#ifdef OPENCV_INCLUDED
#define TT_TENSOR_SUBCLASS_ASSIGN_OPENCV(...) \
...
#ifdef __CUDACC__
#define TT_TENSOR_SUBCLASS_ASSIGN_THRUST(...) \
...
#define TT_TENSOR_SUBCLASS_ASSIGN(...) \
  TT_TENSOR_SUBCLASS_ASSIGN_ALL(__VA_ARGS__) \
  TT_TENSOR_SUBCLASS_ASSIGN_THRUST(__VA_ARGS__) \
  TT_TENSOR_SUBCLASS_ASSIGN_OPENCV(__VA_ARGS__)

// TODO: include ASSERTION in TT_TENSOR_SUBCLASS_FORWARD_ELEMENT_ACCESS
/*#define ASSERTION \
...
*/
#define TT_TENSOR_SUBCLASS_FORWARD_ELEMENT_ACCESS(NAME) \
  HD_WARNING_DISABLE \
...
#define TT_TENSOR_SUBCLASS_FORWARD_ELEMENT_ACCESS_SEQ_N(NAME, N) \
  HD_WARNING_DISABLE \
  ...
  TT_TENSOR_SUBCLASS_FORWARD_ELEMENT_ACCESS(getElementForwardSeqN__)

#define TT_TENSOR_SUBCLASS_FORWARD_ELEMENT_ACCESS_SEQ(NAME) \
  HD_WARNING_DISABLE \
  template <typename TThisType__, typename... TCoordArgTypes__> \
  __host__ __device__ \
  ...
  RETURN_AUTO(NAME(std::forward<TThisType__>(self), metal::iota<metal::number<0>, metal::number<template_tensors::coordinate_num_v<TCoordArgTypes__...>::value>>(), \
    std::forward<TCoordArgTypes__>(coords)...)) \
  TT_TENSOR_SUBCLASS_FORWARD_ELEMENT_ACCESS(getElementForwardSeq__)

#define TT_TENSOR_SUBCLASS_FORWARD_ELEMENT_ACCESS_DIM_T_N(NAME, N) \
  HD_WARNING_DISABLE \
  ...
  TT_TENSOR_SUBCLASS_FORWARD_ELEMENT_ACCESS_SEQ_N(getElementForwardSizeTN__, N)

#define TT_TENSOR_SUBCLASS_FORWARD_ELEMENT_ACCESS_DIM_T(NAME) \
  HD_WARNING_DISABLE \
  template <typename TThisType__, metal::int_... TIndices__, typename... TCoordArgTypes__> \
  __host__ __device__ \
  static auto getElementForwardSizeT__(TThisType__&& self, metal::numbers<TIndices__...>, TCoordArgTypes__&&... coords) \
  RETURN_AUTO(NAME(std::forward<TThisType__>(self), template_tensors::getNthCoordinate<TIndices__>(std::forward<TCoordArgTypes__>(coords)...)...)) \
  TT_TENSOR_SUBCLASS_FORWARD_ELEMENT_ACCESS_SEQ(getElementForwardSizeT__)
