...
template <typename TIndexStrategy = ColMajor, typename TAllocatorIn = util::EmptyDefaultType, typename TTensorType,
  typename TAllocator = WITH_DEFAULT_TYPE(TAllocatorIn, mem::alloc::default_for<mem::memorytype_v<TTensorType>::value>),
...
{
  TResultType result(TENSOR_EXPLICIT_CONSTRUCT_WITH_DYN_DIMS, index_strategy, tensor.dims());
